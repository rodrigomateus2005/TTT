...
declare class EnviandoMensagemEventArgs extends MouraEventArgs {
    Mensagem: string;
    Index: number;
}
declare class MouraSMS extends MouraControl {
...
//# sourceMappingURL=MouraSMS.d.ts.map