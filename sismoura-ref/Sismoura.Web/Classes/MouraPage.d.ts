declare class MouraPage {
    readonly CamposTela: MouraCampo[];
    ...
    protected readonly fullview: MouraButtonTopo;
    protected readonly botaoSair: MouraButtonTopo;
    protected readonly btnHome: MouraButtonTopo;
    protected readonly BotaoAjuda: MouraButtonTopo;
    ...
    private fullview_Click;
    private botaoSair_Click;
    private Deslogar;
    private BotaoAjuda_Click;
...
//# sourceMappingURL=MouraPage.d.ts.map